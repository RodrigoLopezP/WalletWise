...
namespace WalletWise.Migrations
{
    ...
    [Migration("20231109225359_InitialMigration")]
            ...
            modelBuilder.Entity("WalletWise.Models.Entities.ExpenseDetail", b =>
                {
                    ...
                    b.Property<string>("ExdetCurrency")
                        .IsRequired()
                        .HasMaxLength(10)
            ...
            modelBuilder.Entity("WalletWise.Models.Entities.Expense", b =>
                {
                    ...
                    b.OwnsOne("WalletWise.Models.ValueObjects.Money", "Amount", b1 =>
                        {
                            b1.Property<int>("ExpenseExpenId")
                                .HasColumnType("int");
                            ...
                            b1.HasKey("ExpenseExpenId");

                            b1.ToTable("expenses");

                            b1.WithOwner()
                                .HasForeignKey("ExpenseExpenId");
                        });
